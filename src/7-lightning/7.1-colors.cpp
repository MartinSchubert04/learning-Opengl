...
int main() {
  ...
  // ------------------------------------
  Shader shader("shaders/7/color.vs", "shaders/7/color.fs");
  Shader lightCubeShader("shaders/7/color.vs", "shaders/7/lightSource.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    model =
        glm::rotate(model, glm::radians(angle), glm::vec3(3.0f, 6.0f, 1.0f));
