...
int main() {
  ...
  // ------------------------------------
  Shader shader("shaders/7/6/color.vs", "shaders/7/6/color.fs");
  Shader lightCubeShader("shaders/7/6/lightSource.vs",
                         "shaders/7/6/lightSource.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    ImGui::Checkbox("Spotlight", &spotLightOn);
    ...
    for (int i = 0; i < 4; ++i) {
      ...
      shader.setVec3(std::format("pointLights[{}].ambient", i),
                     pointLightAmbient);
      shader.setVec3(std::format("pointLights[{}].diffuse", i),
                     pointLightDiffuse);
      shader.setVec3(std::format("pointLights[{}].specular", i),
                     pointLightSpecular);
